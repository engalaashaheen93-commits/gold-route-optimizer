...
def generate_pdf(ranked: list, meta: dict) -> bytes:
    ...
    pdf.cell(21, 6, f"Cost {wpct('total_cost')}", border=1, fill=True, align="C")
    pdf.cell(21, 6, f"Time {wpct('transit_time')}", border=1, fill=True, align="C")
    pdf.cell(18, 6, f"Geo {wpct('geopolitical')}", border=1, fill=True, align="C")
    pdf.cell(19, 6, f"Wx {wpct('weather_risk')}", border=1, fill=True, align="C")
    pdf.cell(18, 6, f"War {wpct('war_risk')}", border=1, fill=True, align="C")
